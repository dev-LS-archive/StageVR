...
public class DecalProjector : MonoBehaviour
{
    ...
    {
        canvas.ProjectDecal(decal, FFProjector.Orthogonal(transform, ProjectionSize, ProjectionSize, ProjectionNear, ProjectionFar));
    }
    ...
    {
        return Utility.OrthogonalProjector(transform, ProjectionSize, ProjectionSize, ProjectionNear, ProjectionFar);
    }
